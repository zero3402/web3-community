package com.web3community.post.config
        ...
        return http
            ...
            .authorizeHttpRequests { authz ->
                authz
                    ...
                    .requestMatchers("/posts/featured").permitAll()
                    .requestMatchers("/posts/pinned").permitAll()
                    .requestMatchers("/posts/category/*").permitAll()
                    .requestMatchers("/posts/author/*").permitAll()
                    .requestMatchers("/posts/*/exists").permitAll()
                    .requestMatchers("/posts/stats").permitAll()
                    .requestMatchers("/posts/stats/*").permitAll()
